...
Oh, and when defining your adapter, the synchronous AMQP adapter should be defined as <tty>:amqp_synch</tty>, and the evented adapter as <tty>:amqp_evented</tty>.
